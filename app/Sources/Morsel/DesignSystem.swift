...
extension Color {
    ...
    static let morselAccent = Color(paletteHex: "#3E63E8")
    static let morselAccentSoft = Color(paletteHex: "#E9EEFC")
    ...
    static let morselProtein = Color(paletteHex: "#6C5CE7")
    static let morselCarbs = Color(paletteHex: "#F0A63C")
    static let morselFat = Color(paletteHex: "#0FA6A0")

    static let morselProteinStart = Color(paletteHex: "#9C8BF5")
    static let morselCarbsStart = Color(paletteHex: "#FFC24B")
    static let morselFatStart = Color(paletteHex: "#37D5C2")
    static let morselUnderStart = Color(paletteHex: "#5BD8E6")
    static let morselUnder = Color(paletteHex: "#1FA3C4")
    static let morselOnStart = Color(paletteHex: "#3BC8A8")
    static let morselOn = Color(paletteHex: "#12A98E")
    static let morselOverStart = Color(paletteHex: "#F7A98C")
    static let morselOverEnd = Color(paletteHex: "#E0765F")
